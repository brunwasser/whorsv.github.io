...
```{r, figure.height = 30, figure.width = 35}
...
levels( looplotdf1$parameter) <- c( 'a.\nConditional Mean (Intercept)',
                       'b.\nModifying Influence of Controlling\n for Genetic Confounding')
...
As expected, the confidence interval is very large, spanning OR values from 0.04 to 36.27. Consequently, we cannot rule out that getting a placebo instead of RSV immunoprophylaxis has either a strong protective effect or a highly damaging effect.
